...
namespace Microsoft.Azure.Devices.E2ETests
{
    ...
    public class FileUploadE2ETests
    {
        ...
        private readonly Mutex sequentialTestMutex = new Mutex(true, "runTestSequentiallyMutexString");
        ...
        {
            sequentialTestMutex.WaitOne(TimeSpan.FromSeconds(20));
        }

        [TestCleanup]
        public void Cleanup()
        {
            sequentialTestMutex.ReleaseMutex();
        }
